...
def evaluate_qwen_outputs(root_dir, metrics, methods=["base", "lora", "lora_2000"]):
    # 动态初始化结果字典
    ...
    for dirpath, dirnames, filenames in os.walk(root_dir):
        ...
        gt_path = os.path.join(dirpath, "output_gt.png")
...
if __name__ == "__main__":
    ...
    # root_directory = "/path/to/local_storage/qwen-image-finetune/qwen_outputs/gpt5_data/m365_data"
    root_directory = "/path/to/local_storage/office-wm/qwen-image-finetune/qwen_outputs/gpt5_data/qabench"
    # methods = ["gt", "base"] + [f"lora_{step}" for step in range(1000, 9001, 1000)]
    methods = ["gt", "base", "yiming"]
    results = evaluate_qwen_outputs(root_directory, metrics, methods=methods)
