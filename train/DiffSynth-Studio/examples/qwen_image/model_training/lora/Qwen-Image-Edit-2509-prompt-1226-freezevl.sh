...
accelerate launch examples/qwen_image/model_training/train.py \
  --dataset_base_path /scratch/gym \
  --dataset_metadata_path examples/qwen_image/model_training/lora/pairs_summary_data_sample_3000_train_prompt_1226.csv \
  ...
  --output_path "models/train/Qwen-Image-Edit-2509_data_sample_3000_freezeqwenvl_lora_prompt1226" \
  --lora_base_model "dit" \
