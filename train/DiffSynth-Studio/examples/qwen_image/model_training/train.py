...
# wandb will be initialized by ModelLogger when use_wandb=True
...
class QwenImageTrainingModule(DiffusionTrainingModule):
    ...
    @torch.no_grad()
    def generate(self, example_data, inference_steps=40):
        self.eval()
        
        edit_image, prompt = example_data["edit_image"], example_data["prompt"]
        image = self.pipe(
            prompt, 
            edit_image=edit_image, 
            seed=123, 
            num_inference_steps=inference_steps, 
            height=edit_image.size[1], 
            width=edit_image.size[0]
        )
...
if __name__ == "__main__":
    ...
    # example inputs for qabench (use prev.png as input image)
    base_qabench = "/path/to/local_storage/gpt5_data/qabench"
    example_inputs = {
        "Word_1_4_pair_01": os.path.join(base_qabench, "word_1_4", "pair_01", "prev.png"),
        "Word_1_13_pair_02": os.path.join(base_qabench, "word_1_13", "pair_02", "prev.png"),
        "Word_1_67_pair_02": os.path.join(base_qabench, "word_1_67", "pair_02", "prev.png"),
        "Word_1_187_pair_01": os.path.join(base_qabench, "word_1_187", "pair_01", "prev.png"),
    }

    wandb_cfg = {"project": "diffsynth-qwen-image", "name": "lora-2509"}
